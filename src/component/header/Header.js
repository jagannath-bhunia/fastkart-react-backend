        ...
        <nav className="navbar navbar-expand gap-3">
            ...
            <ul className="navbar-nav align-items-center gap-1">
              ...
              <li className="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  ...
                  <li><a className="dropdown-item d-flex align-items-center py-2" href="javascript:;">
                    <img src="assets/images/county/07.png" width="20" alt="" /><span className="ms-2">Georgian</span></a>
                  </li>
                  <li>
                    <a className="dropdown-item d-flex align-items-center py-2" href="javascript:;">
                      <img src="assets/images/county/08.png" width="20" alt="" /><span className="ms-2">Hindi</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li className="nav-item dropdown dropdown-large">
                <a className="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" data-bs-toggle="dropdown">
          ...
          <div className="user-box dropdown px-3">
            ...
            <ul className="dropdown-menu dropdown-menu-end">
              ...
              <li><a className="dropdown-item d-flex align-items-center" href="javascript:;" onClick={logOut}><i className="bx bx-log-out-circle"></i><span>Logout</span></a>
              </li>
            </ul>
          </div>
        </nav>
